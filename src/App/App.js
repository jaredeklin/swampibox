...
import { fetchFilmData, cleanFilmData, fetchVehicleData, fetchPlanetData } from '../helpers/apiHelper';
    ...
    return (
      <div className="App">
        ...
        { 
          ...
          <ButtonContainer getData={this.getData} active={this.state.active} favorites={this.state.favorites.length}/>
          { 
